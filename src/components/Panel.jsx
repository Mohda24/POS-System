...
function Panel() {
  ...
  const CalcTotale = () => {
    getProductsFromLocalStorage().forEach(prod => {
      setTotale(prev => ((prod.price*prod.count) + prev).toFixed(2) * 1)
    })
  }
  ...
  return (
    <section className="px-[20px] py-[20px] w-[350px] bg-white fixed top-0 right-0 min-h-[100vh] grid grid-rows-[1fr_200px]">
      ...
      <div>
        ...
        <div className="Espece relative px-[10px] py-[8px] rounded-[12px] border-[1px] border-[#AAAAAA] flex focus-within:focus">
          <input
            type="number"
          ...
          <span
            className={`placeholder w-[54px] h-[17px] text-[#AAAAAA] bg-white text-[14px] absolute top-[50%] translate-y-[-50%] duration-300 ease-in-out pointer-events-none text-center ${
              especeValue ? "!top-[0px]" : ""
            }`}
          >
            Espèce
        ...
        {/* redection */}
        <div className="Redection relative px-[10px] py-[8px] rounded-[12px] border-[1px] border-[#AAAAAA] flex focus-within:focus">
          <input
            type="number"
          ...
          <span
            className={`placeholder w-[71px] h-[17px] text-[#AAAAAA] bg-white text-[14px] absolute top-[50%] translate-y-[-50%] duration-300 ease-in-out pointer-events-none text-center ${
              reductionValue ? "!top-[0px]" : ""
            }`}
          >
            Réduction
          </span>
        ...
        <div className="caise flex gap-[10px]">
          <div
            ...
            className={`p-[5px] border-2 rounded-[16px] flex flex-col gap-[4px] items-center w-full cursor-pointer select-none ${
              caise === "espece"
