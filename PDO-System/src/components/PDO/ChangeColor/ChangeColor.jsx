...
function ChangeColor() {
    ...
    return (
        <div className={`changeColor fixed ${coloPanel ? 'right-0' :'right-[-100%]'} top-0 px-[15px] py-[10px] flex flex-col items-center gap-[20px] bg-secondary shadow-2xl rounded-md duration-300 ease-out`}>
